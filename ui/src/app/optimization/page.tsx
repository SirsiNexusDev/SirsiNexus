      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white shadow-sm border border-gray-200 p-6 rounded-lg h-full flex flex-col justify-between">
              <div className="mb-6">
                    ...
                    <div className="space-y-6">
                      ...
                      {optimizationData && (
                        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">Optimization Overview</h3>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center">
                              <div className="text-2xl font-bold text-gray-900">${optimizationData.totalCost.toLocaleString()}</div>
                              <div className="text-sm text-gray-600">Current Monthly Cost</div>
                            </div>
                            <div className="text-center">
                              <div className="text-2xl font-bold text-green-600">${optimizationData.potentialSavings.toLocaleString()}</div>
                              <div className="text-sm text-gray-600">Potential Monthly Savings</div>
                            </div>
                            <div className="text-center">
                              <div className="text-2xl font-bold text-blue-600">{Math.round((optimizationData.potentialSavings / optimizationData.totalCost) * 100)}%</div>
                  ...
                  {artifacts.map((artifact) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="bg-blue-50 text-blue-700 hover:bg-blue-100 px-2 py-1 rounded"
                      >
