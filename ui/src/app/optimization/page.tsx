...
export default function OptimizationWizardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-6">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">
                Steps
              </h2>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          <h3 className={`text-sm font-medium ${
                            isActive ? 'text-blue-900 dark:text-blue-200' : isCompleted ? 'text-green-900 dark:text-green-200' : 'text-gray-900 dark:text-gray-100 dark:text-gray-100'
                          }`}>
                            {config.title}
                          </h3>
                          <p className={`text-xs ${
                            isActive ? 'text-blue-600 dark:text-blue-400' : isCompleted ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400 dark:text-gray-400'
                          }`}>
                            {config.description}
                          </p>
                        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-6 rounded-lg h-full flex flex-col justify-between">
              <div className="mb-6">
                ...
                >
                  ...
                  {currentStep !== 'optimize' && currentStep !== 'environment' && (
                    <div className="space-y-6">
                      ...
                      {optimizationData && (
                        <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:to-gray-800 dark:from-gray-900 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg p-6 border border-green-200 dark:border-green-700">
                          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-gray-100 mb-4">Optimization Overview</h3>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center">
                              <div className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100">${optimizationData.totalCost.toLocaleString()}</div>
                              <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Current Monthly Cost</div>
                            </div>
                            <div className="text-center">
                              <div className="text-2xl font-bold text-green-600 dark:text-green-400">${optimizationData.potentialSavings.toLocaleString()}</div>
                              <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Potential Monthly Savings</div>
                            </div>
                            <div className="text-center">
                              ...
                              <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Optimization Potential</div>
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 dark:border-gray-700 p-6">
                        <div className="text-center py-8">
                          ...
                          <button
                            ...
                            className="bg-green-600 dark:bg-green-500 hover:bg-green-700 dark:hover:bg-green-600 text-white px-6 py-3 rounded-lg font-medium"
                          >
