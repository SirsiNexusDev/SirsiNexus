              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-left"
                  >
                    <div className="flex items-center gap-2">
                      <span className="text-lg">{selectedProvider?.icon}</span>
                      <span className="text-gray-900">{selectedProvider?.label}</span>
                    </div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-left"
                  >
                    <span className="text-gray-900">{selectedStrategy?.label}</span>
                    <ChevronDown className="h-5 w-5 text-gray-400" />
                  </button>
                  <p className="mt-1 text-sm text-gray-500">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3 bg-gray-50 px-4 py-3 rounded-lg">
                      ...
                      />
                      <label htmlFor="has-databases" className="flex items-center gap-2 text-gray-700 font-medium cursor-pointer">
                  ...
                  <div className="flex items-center gap-3 bg-gray-50 px-4 py-3 rounded-lg">
                    <input
                      ...
                      className="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label htmlFor="has-ad" className="flex items-center gap-2 text-gray-700 font-medium cursor-pointer">
